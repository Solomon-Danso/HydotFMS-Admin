...
const handleDeleteAdmin = async (id) => {
  ...
  return (
    <div>
      <Header category="User Management" title="Admin" />

      <div className="wwd-row">

        <div className="card" style={{ backgroundColor: localStorage.getItem("themeMode") === "Light" ? "#26293C" : "white" }}>
          <div className="sec-title" style={{ color: localStorage.getItem("colorMode"), padding: "2rem" }}>Add  Admin </div>
          ...
          <div>
              <FormLable style={{ color: localStorage.getItem("colorMode") }}>Enter  Admin Id</FormLable>
              <FormInputStudent
                type="text"
                required
                placeholder=""
