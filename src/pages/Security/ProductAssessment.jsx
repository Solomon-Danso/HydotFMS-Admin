...
import {  auditTrialGrid, checkingGrid, contextMenuItems, CustomerdeliveryGrid, customerTrialGrid, deliveryGrid, prdAssGrid } from '../../data/champion';
...
fetch(apiServer+"ViewProductAssessment",{
  method: "POST",
      headers: {
...
.catch(err=>console.error(err))
  ...
  return (
    <div>
      <Header category="Security" title="Product Assessment" />
