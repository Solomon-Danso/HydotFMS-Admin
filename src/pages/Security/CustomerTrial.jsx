...
import {  auditTrialGrid, checkingGrid, contextMenuItems, CustomerdeliveryGrid, customerTrialGrid, deliveryGrid } from '../../data/champion';
...
fetch(apiServer+"ViewCustomerTrail",{
  method: "POST",
      headers: {
...
.catch(err=>console.error(err))
  ...
  return (
    <div>
      <Header category="Security" title="Customer Trail" />
      ...
      toolbar={['Search']}  // Add the search bar
        ...
        >
          <ColumnsDirective>
            {customerTrialGrid.map((item, index) => (
