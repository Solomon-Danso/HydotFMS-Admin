...
import {  auditTrialGrid, checkingGrid, contextMenuItems, CustomerdeliveryGrid, deliveryGrid } from '../../data/champion';
...
fetch(apiServer+"ViewAuditTrail",{
  method: "POST",
      headers: {
...
.catch(err=>console.error(err))
  ...
  return (
    <div>
      <Header category="Security" title="Audit Trail" />
