...
useEffect(()=>{
  ...
  fetch(apiServer+"ViewSpecificExploreSRC",{
    method: "POST",
        headers: {
...
formData.append("CoverType",CoverType);
    ...
    const response = await fetch(apiServer+"CreateExploreSRC", {
      method: "POST",
      headers: {
        'UserId': userInfo.UserId,         
        'SessionId': userInfo.SessionId    
...
const handleDeleteAdmin = async (Id, ExploreID) => {
  ...
  formData.append("AdminId",userInfo.UserId)
      ...
      const response = await fetch(apiServer+"DeletedExploreSRC", {
        method: "POST",
        headers: {
          'UserId': userInfo.UserId,         
          'SessionId': userInfo.SessionId    
...
const handleReset = () => {
  ...
  return (
    <div>
      <Header category="Website Configuration" title="Explore Media" />
