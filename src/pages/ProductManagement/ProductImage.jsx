...
const menuItems = [

  {
    ...
    type: "function",
    onClick: (id) => {
      handleConfirmation(id); // Assuming this function is defined in your component
    },
...
const handleConfirmation = (id) =>{
  ...
  Show.Confirm("Do you want to Delete, Action cannot be reversed ", () => handleDelete(id)  );
}
...
const handleReset = () => {
  ...
  return (
    <div>
      <Header category="E-commerce Mgmt" title="Products Images" />
