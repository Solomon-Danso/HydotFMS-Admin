...
import { categoryGrid, contextMenuItems, continentList, countryList, customers, customersData, customersGrid, emailData, emailGrid, employeeData, employeeGrid, otherGrid, paymentData, paymentGrid, paymentMethod, paymentReference, productGrid, productImageGrid, products } from '../../data/champion';
...
fetch(apiServer+"ViewProductImage",{
  method: "POST",
      headers: {
...
formData.append("ProductId",productId);
    ...
    const response = await fetch(apiServer+"ProductImage", {
      method: "POST",
      headers: {
        'UserId': userInfo.UserId,         
        'SessionId': userInfo.SessionId    
    ...
    <div>
      ...
      <div className="wwd-row">
        ...
        <div className="card" style={{ backgroundColor: localStorage.getItem("themeMode") === "Light" ? "#26293C" : "white" }}>
          <div className="sec-title" style={{ color: localStorage.getItem("colorMode"), padding: "2rem" }}>Add  Image </div>
