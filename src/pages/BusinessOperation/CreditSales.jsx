...
import {  checkingGrid, contextMenuItems, creditSalesGrid } from '../../data/champion';
...
fetch(apiServer+"ViewAwaitingCreditSales",{
  method: "POST",
      headers: {
...
.catch(err=>console.error(err))
  ...
  return (
    <div>
      <Header category="Business Operation" title="Credit Sales" />
      ...
      toolbar={['Search']}  // Add the search bar
        ...
        >
          <ColumnsDirective>
            {creditSalesGrid.map((item, index) => (
