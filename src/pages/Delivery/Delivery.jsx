...
useEffect(() => {
  ...
  fetch(apiServer + "ViewUnAssignedDelivery", {
    method: "POST",
    headers: {
...
const menuItems = [
  {
    ...
    text: "View Details",
    type: "navigate",
    path: `/main/delivery/:OrderId/:DeliveryId`, // Placeholder for the dynamic segment
  },
...
const sample = [
  ...
  return (
    <div>
      <Header category="E-commerce Mgmt" title="Delivery" />
